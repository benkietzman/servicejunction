...
///////////////////////////////////////////
/*! \file jira.cpp
* \brief Atlassian JIRA
*
* Provides an interface to Atlassian's JIRA REST service.
*/
// {{{ includes
#include <ctime>
#include <fstream>
...
int main(int argc, char *argv[])
{
  ...
  if (strError.empty())
  {
    ...
    string strApi = "api", strSubError, strVersion = "latest";
    stringstream ssDuration;
    time_t CEndTime, CStartTime;
    pJunction->setApplication("Service Junction (jira)");
